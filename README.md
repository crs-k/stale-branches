...
| `stale-branch-label` | Label to be applied to issues created for stale branches. **As of v2, this _must_ be unique to this workflow** | `stale branch 🗑️` |
...
jobs:
  stale_branches:
    ...
    steps:
    - name: Stale Branches
      uses: crs-k/stale-branches@v1.7.0
```
### With Inputs
```yaml
# .github/workflows/stale-branches.yml
